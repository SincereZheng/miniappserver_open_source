function fixDate(str) {
    var mon_en = ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"];
    var mon_cn = ["10月", "11月", "12月", "1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月"];

    for (var i = 0; i < mon_cn.length; i++) {
        str = str.replace(mon_cn[i], mon_en[i]);
    }
