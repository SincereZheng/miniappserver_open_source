...
(function ($) {
    ...
    BootstrapTable.prototype.init = function () {
        ...
        //Disable input special char
        $(".bootstrap-table .fixed-table-toolbar .search input").on('input propertychange', function () {
            var value = $(this).val();
            ...
            for (var v in arr) {
                ...
                if (pattern.test(arr[v])) {
                    res = String.IsNullOrEmpty(res) ? value.slice(0, value.length - 1) : res.slice(0, res.length - 1);
                    b = true;
                }
            }
            if (b) {
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        ...
        if (text.indexOf("'") > -1) {
            alert("Can't input special char:'");
            return
        }
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = that.options.cardView ? ['<div class="card-view">',
                        ...
                        sprintf('<span class="value">%s</span>', value === undefined ? "":value),
                        '</div>'
    ...
    BootstrapTable.prototype.getSelectedRowIndex = function () {
        var that = this;
        var index = -1;
    ...
    BootstrapTable.prototype.refresh = function (params) {
        ...
        var $search = this.$toolbar.find('.search input');
        if ($search) {
            this.searchText = $.trim($search.val());
        }
